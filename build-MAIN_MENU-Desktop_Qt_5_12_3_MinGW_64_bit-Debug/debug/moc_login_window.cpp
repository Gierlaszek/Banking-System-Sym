...
#include "../../MAIN_MENU/login_window.h"
...
struct qt_meta_stringdata_login_window_t {
    QByteArrayData data[4];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_login_window_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_login_window_t qt_meta_stringdata_login_window = {
    {
QT_MOC_LITERAL(0, 0, 12), // "login_window"
QT_MOC_LITERAL(1, 13, 21), // "on_backButton_clicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 22) // "on_loginButton_clicked"

    },
    "login_window\0on_backButton_clicked\0\0"
...
void login_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<login_window *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject login_window::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_login_window.data,
    qt_meta_data_login_window,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *login_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_login_window.stringdata0))
